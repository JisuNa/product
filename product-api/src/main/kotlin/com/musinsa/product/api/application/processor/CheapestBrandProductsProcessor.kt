...
class CheapestBrandProductsProcessor(private val productRepository: ProductRepository) {
    fun execute(): BrandDto {
        ...
        return cheapestBrandDto.apply {
            products = minPriceProductDtos
            totalPrice = minPriceProductDtos.sumOf { it.price }
        }
    }
}
